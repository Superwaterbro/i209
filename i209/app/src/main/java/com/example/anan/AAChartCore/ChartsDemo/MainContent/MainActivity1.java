...
public class MainActivity1 extends AppCompatActivity implements OnGetGeoCoderResultListener {
    ...
    public void onGetGeoCodeResult(GeoCodeResult result) {
        if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
            Toast.makeText(MainActivity1.this, "抱歉，未能找到结果", Toast.LENGTH_LONG)
                    .show();
            return;
        }
        baiduMap.clear();
        ...
        Toast.makeText(MainActivity1.this, strInfo, Toast.LENGTH_LONG).show();
        ...
        goButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!BaiduNaviManager.isNaviInited()) {
                    Toast.makeText(MainActivity1.this, "授权失败", Toast.LENGTH_SHORT).show();
                    return;
                }
                /**
                 * 获取该点的坐标位置
                ...
                Toast.makeText(MainActivity1.this, "开始获取起点和终点", Toast.LENGTH_SHORT).show();
                ...
                if (sNode != null && eNode != null) {
                    ...
                    BaiduNaviManager
                            .getInstance()
                            .launchNavigator(
                                    MainActivity1.this,               //建议是应用的主Activity
        ...
        BaiduNaviManager.getInstance().init(this, mSDCardPath, APP_FOLDER_NAME, new BaiduNaviManager.NaviInitListener() {
            ...
            public void onAuthResult(int status, String msg) {
                ...
                MainActivity1.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(MainActivity1.this, authinfo, Toast.LENGTH_LONG).show();
                    }
                });
            }
            ...
            public void initFailed() {
                Toast.makeText(MainActivity1.this, "百度导航引擎初始化失败", Toast.LENGTH_SHORT).show();
            }
    ...
    private class PoiSearchListener implements OnGetPoiSearchResultListener {
        ...
        public void onGetPoiResult(PoiResult poiResult) {
            if (poiResult == null
                ...
                Toast.makeText(MainActivity1.this, "未找到结果", Toast.LENGTH_LONG)
                        .show();
                return;
            }
            ...
            if (poiResult.error == SearchResult.ERRORNO.AMBIGUOUS_KEYWORD) {
                ...
                strInfo += "找到结果";
                Toast.makeText(MainActivity1.this, strInfo, Toast.LENGTH_LONG)
                        .show();
            }
        }
        ...
        public void onGetPoiDetailResult(PoiDetailResult poiDetailResult) {
            ...
            if (poiDetailResult.error == SearchResult.ERRORNO.NO_ERROR) {
                ...
                Toast.makeText(MainActivity1.this, "hhah", Toast.LENGTH_LONG).show();
                return;
            }
    ...
    private class SuggestionResultListener implements OnGetSuggestionResultListener {
        ...
        public void onGetSuggestionResult(final SuggestionResult suggestionResult) {
            ...
            adapter = new ArrayAdapter<String>(MainActivity1.this, android.R.layout.simple_dropdown_item_1line, suggest);
    ...
    public class DemoRoutePlanListener implements BaiduNaviManager.RoutePlanListener {
        ...
        public void onJumpToNavigator() {
             ...
             * 导航activity
             */
            Intent intent = new Intent(MainActivity1.this, GuideActivity.class);
            Bundle bundle = new Bundle();
        ...
        public void onRoutePlanFailed() {
            // TODO Auto-generated method stub
            Toast.makeText(MainActivity1.this, "算路失败", Toast.LENGTH_SHORT).show();
        }
    }
